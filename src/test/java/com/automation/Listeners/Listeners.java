...
import com.automation.Configuration.ExtentReporterNG;
...
public class Listeners extends BaseConfig implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			extentTest.get().addScreenCaptureFromPath(getScreenShotPath(driver,testMethodName), result.getMethod().getMethodName());
